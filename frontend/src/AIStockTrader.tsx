...
export default function AIStockTrader() {
  ...
  return (
    <div className={`bg-slate-950 h-screen text-white flex overflow-hidden transition-all duration-300 ${!user ? 'items-center justify-center' : ''}`}>
      {!user && <LoginScreen onLogin={handleLogin} />}

      {user && (
        <div className="flex w-full h-screen overflow-hidden min-w-0">
          <nav className="hidden lg:flex flex-col w-64 flex-shrink-0 bg-slate-900 border-r border-slate-800 p-4 space-y-6">
          ...
          <main className="flex-1 flex flex-col min-h-0">
            <header className="flex-shrink-0 border-b border-slate-800 bg-slate-900/50 backdrop-blur-sm sticky top-0 z-40">
